...
class Empleado(models.Model):
    ...
    class Meta:
        db_table = 'rrhh_empleado'  # Nombre personalizado de la tabla
...
class Nomina(models.Model):
    ...
    class Meta:
        db_table = 'rrhh_nomina'  # Nombre personalizado de la tabla
...
class Ausentismo(models.Model):
    ...
    class Meta:
        db_table = 'rrhh_ausentismo'  # Nombre personalizado de la tabla
...
class HoraExtra(models.Model):
    ...
    class Meta:
        db_table = 'rrhh_hora_extra'  # Nombre personalizado de la tabla
...
class Contact(models.Model):
    ...
    class Meta:
        db_table = 'rrhh_contact'  # Nombre personalizado de la tabla
